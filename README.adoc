...
* Dans la classe Tournoi, la classe Match est un duplicata de la classe MatchM présente dans un fichier à part. Elle n'a que pour utilité d'avoir un constructeur simplifié. Il a donc fallu déplacer se constructeur dans la classe MatchM.
